...
public class Castigo1 extends AppCompatActivity {
    TextView txt;
    String dato1;
    String dato2;
    String nombrefinal;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_castigo1);


        String[] nums = this.getResources().getStringArray(R.array.cast);
    ...
    public void boton_click (View sender){
        Intent SegundaPR = new Intent(getApplicationContext(), SegundaPregunta.class);
