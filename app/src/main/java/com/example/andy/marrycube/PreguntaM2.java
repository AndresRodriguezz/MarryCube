...
public class PreguntaM2 extends AppCompatActivity {
    TextView ejemplo;
    public String dato1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pregunta_m2);
    ...
    public void boton_click (View sender)
    {
        ...
        if (nombre.length() != 0 && nombre2.length() != 0) {
            Intent SegundaPR = new Intent(getApplicationContext(), Castigo2M.class);
