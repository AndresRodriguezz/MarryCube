...
public class PreguntaM3 extends AppCompatActivity {
    TextView ejem;
    String dato1;
    String dato2;
    EditText txt1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pregunta_m3);     txt1 = (EditText) findViewById(R.id.texto1);
    ...
    public void boton_click(View sender)
    {
        ...
        if (nombre.length() != 0 && nombre2.length() != 0) {
            Intent SegundaPR = new Intent(getApplicationContext(), Castigo3M.class);
