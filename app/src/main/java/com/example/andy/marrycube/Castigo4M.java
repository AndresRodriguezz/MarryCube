...
public class Castigo4M extends AppCompatActivity {
    String dato1;
    String dato2;
    String dato3;
    String dato4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_castigo4_m);        String[] nums = this.getResources().getStringArray(R.array.Hijos);
    ...
    public void boton_click (View sender){
        Intent SegundaPR = new Intent(getApplicationContext(), MResultado.class);
