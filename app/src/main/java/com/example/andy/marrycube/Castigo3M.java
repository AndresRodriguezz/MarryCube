...
public class Castigo3M extends AppCompatActivity {
    TextView txt;
    String dato1;
    String dato2;
    String dato3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_castigo3_m);
    ...
    public void boton_click (View sender){
        Intent SegundaPR = new Intent(getApplicationContext(), PreguntaM4.class);
